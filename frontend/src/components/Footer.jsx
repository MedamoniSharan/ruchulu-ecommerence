        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-8">
          ...
          <div className="flex flex-col items-center w-full md:w-1/5">
            ...
            <ul className="space-y-4 text-center">
              <li className="flex items-center justify-center space-x-3">
                ...
                <span className="text-white/90">4-7-62/2, Shivaji nagar, Attapur, Hyderabad City, Telangana state 500148.</span>
              </li>
              <li className="flex items-center justify-center space-x-3">
                <svg className="w-5 h-5 text-white/80 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="text-white/90">+91 9701555435</span>
              </li>
              <li className="flex items-center justify-center space-x-3">
                <svg className="w-5 h-5 text-white/80 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-white/90">maammaruchulur@gmail.com</span>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col items-center w-full md:w-1/5">
            ...
            <ul className="space-y-3 text-center">
              <li>
                <Link to="/terms-conditions" className="text-white/90 hover:text-white transition-colors">
                  Terms & Conditions
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/shipping-policy" className="text-white/90 hover:text-white transition-colors">
                  Shipping Policy
                </Link>
              </li>
              <li>
                <Link to="/cancellation-policy" className="text-white/90 hover:text-white transition-colors">
                  Cancellation Policy
                </Link>
              </li>
            </ul>
          ...
          <div className="flex flex-col items-center w-full md:w-1/5">
            ...
            <ul className="space-y-3 text-center">
              <li>
                <a href="#" className="flex items-center justify-center space-x-3 text-white/90 hover:text-white transition-colors">
